...
## <i style="color:var(--color-accent)" class="fa-solid fa-circle-info">&nbsp;</i>About me

##### <i style="color:var(--color-tertiary)" class="fa-solid fa-code">&nbsp;</i> Web Development Expertise  
...
##### <i style="color:var(--color-tertiary)" class="fa-solid fa-earth-americas">&nbsp;</i> Global Communication Proficiency  
...
##### <i style="color:var(--color-tertiary)" class="fa-solid fa-terminal">&nbsp;</i> Love for all things Linux  
